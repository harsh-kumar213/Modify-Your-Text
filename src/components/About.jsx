...
export default function About(props) {
  ...
  return (
    <>
    <div classNameName="container" style ={{backgroundColor: (props.mode==='dark')?'#042743':'white',color:(props.mode==='dark')?'white':'black'}}>
            <h1 className='my-3'>About Us</h1>
        <div className="accordion" id="accordionExample">
        <div className="accordion-item">
            <h2 className="accordion-header">
            <button className="accordion-button collapsed" style ={{backgroundColor: (props.mode==='dark')?'#042743':'white',color:(props.mode==='dark')?'white':'black'}} type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
             Accordion Item #1
            </button>
            </h2>
